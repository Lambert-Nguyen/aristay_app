...
from api.models import Booking, BookingImportLog, Property
...
class TestEnhancedExcelImport:
    ...
    def setup_test_data(self):
        ...
        self.user, created = User.objects.get_or_create(
            ...
            defaults={"email": "test@example.com", "first_name": "Test", "last_name": "User", "is_staff": True},
        )
        if created:
        ...
        self.property, created = Property.objects.get_or_create(
            ...
            defaults={"address": "123 Test Street", "city": "Test City", "state": "CA", "zip_code": "12345"},
        )
        if created:
    ...
    def test_conflict_resolution_service(self):
        ...
        # Test resolution
        resolutions = [{"conflict_index": 0, "action": "update_existing", "apply_changes": ["guest_name"]}]
