...
class TaskModelTest(BaseTestCase):
    ...
    def test_task_str_representation(self):
        ...
        task = Task.objects.create(
            property=self.property1, booking=self.booking, title="Test Task", created_by=self.admin_user
        )
    ...
    def test_task_status_choices(self):
        ...
        task = Task.objects.create(property=self.property1, title="Test Task", created_by=self.admin_user, status="completed")
...
class PropertyOwnershipModelTest(BaseTestCase):
    ...
    def test_property_ownership_creation(self):
        ...
        ownership = PropertyOwnership.objects.create(
            property=self.property1, user=self.manager_user, ownership_type="manager", can_edit=True
        )
    ...
    def test_property_ownership_unique_constraint(self):
        ...
        PropertyOwnership.objects.create(property=self.property1, user=self.manager_user, ownership_type="manager")
    ...
    def test_property_ownership_str_representation(self):
        ...
        ownership = PropertyOwnership.objects.create(property=self.property1, user=self.manager_user, ownership_type="viewer")
...
class DeviceModelTest(BaseTestCase):
    ...
    def test_device_creation(self):
        ...
        device = Device.objects.create(user=self.staff_user, token="test_fcm_token_123")
    ...
    def test_device_str_representation(self):
        ...
        device = Device.objects.create(user=self.staff_user, token="test_token")
...
class NotificationModelTest(BaseTestCase):
    ...
    def test_notification_creation(self):
        ...
        notification = Notification.objects.create(recipient=self.staff_user, task=self.task, verb=NotificationVerb.ASSIGNED)
