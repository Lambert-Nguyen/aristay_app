...
from api.permissions import DynamicPropertyPermissions, DynamicTaskPermissions, IsManagerOrOwner, IsOwnerOrAssignedOrReadOnly
...
class PermissionTest(BaseAPITestCase):
    ...
    def setUp(self):
        ...
        self.booking = Booking.objects.create(
            property=self.property1, check_in_date="2024-12-01", check_out_date="2024-12-05", guest_name="Test Guest"
        )
    ...
    def test_staff_cannot_modify_unassigned_tasks(self):
        ...
        test_id = str(id(self))
        other_staff = User.objects.create_user(username=f"other_staff_{test_id}", password="testpass123")
