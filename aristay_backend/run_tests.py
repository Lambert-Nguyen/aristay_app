...
def main():
    ...
    test_commands = [
        ...
        },
        {
            ...
            'description': 'Django Deployment Check',
            'critical': False
        },
        {
        ...
        {
            'command': 'python manage.py test tests.test_models --verbosity=2',
    ...
    for test_file in existing_tests:
        if os.path.exists(test_file):
            test_commands.append({
                ...
                'description': f'Legacy Test: {test_file}',
                'critical': False
            })
    ...
    critical_failures = [
        name for name, result in results['test_suites'].items()
