...
from .models import Booking, Device, Notification, Profile, Property, PropertyOwnership, Task, TaskImage, UserRole
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "is_staff",
            "is_superuser",
            "is_active",  # ← include is_superuser
            "role",
            "timezone",
            "system_timezone",
        ]
...
class PropertyOwnershipSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "property", "property_name", "user", "username", "email", "ownership_type", "can_edit", "created_at"]
