...
from .models import Notification, Profile, Property, Task
        ...
        try:
            ...
            return {
                "task_metrics": {
                    ...
                    "overdue": Task.objects.filter(due_date__lt=now, status__in=["pending", "in_progress"]).count(),
                },
                "user_metrics": {
    ...
    def get_user_activity_metrics(self):
        ...
        try:
            ...
            return {
                ...
                "task_activity": {
                    "created_24h": Task.objects.filter(created_at__gte=last_24h).count(),
                    "completed_24h": Task.objects.filter(modified_at__gte=last_24h, status="completed").count(),
                },
    ...
    def _get_most_active_users(self, limit=5):
        ...
        try:
            return list(
                ...
                .values("username", "first_name", "last_name", "task_count")
            )
        except:
            return []
