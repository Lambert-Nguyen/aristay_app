...
from api.models import ChecklistTemplate, Property, ScheduleTemplate
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Created {schedules_created} recurring schedule templates"))
